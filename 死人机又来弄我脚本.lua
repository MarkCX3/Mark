...
local Window = OrionLib:MakeWindow({Name = "奕泽二改脚本", HidePremium = false, SaveConfig = true,IntroText = "奕泽二改脚本", ConfigFolder = "奕泽二改脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "奕泽二改脚本"; Text ="奕泽二改脚本"; Duration = 4; })
